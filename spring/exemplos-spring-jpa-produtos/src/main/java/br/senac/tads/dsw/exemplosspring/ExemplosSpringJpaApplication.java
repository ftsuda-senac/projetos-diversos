...
public class ExemplosSpringJpaApplication /* implements CommandLineRunner  */ {
    ...
    private Produto construirProduto(String nomeProduto, BigDecimal precoCompra,
            BigDecimal precoVenda, int quantidade, Set<ImagemProduto> imagens,
            Set<Categoria> categorias) {
        Produto p = new Produto(nomeProduto, "Descrição do produto " + nomeProduto, precoCompra,
                precoVenda, quantidade, true, LocalDateTime.now());
    ...
    private void incluirCategoriasProdutos() {
        ...
        for (int i = 1; i < 11; i++) {
            ...
            imagens.add(
                    new ImagemProduto("http://lorempixel.com/300/300/technics/1/", "technics 1"));
            imagens.add(
                    new ImagemProduto("http://lorempixel.com/300/300/technics/2/", "technics 2"));
            imagens.add(
                    new ImagemProduto("http://lorempixel.com/300/300/technics/7/", "technics 7"));
            categorias = new LinkedHashSet<>();
            categorias.add(todasCategorias.get(0));
            categorias.add(todasCategorias.get(1));
            p = construirProduto(nomeProduto, new BigDecimal(100.0), new BigDecimal(200.0), 100,
                    imagens, categorias);
            ...
            p = construirProduto(nomeProduto, new BigDecimal(40.0), new BigDecimal(70.0), 250,
                    imagens, categorias);
            produtoRepository.save(p);
            ...
            p = construirProduto(nomeProduto, new BigDecimal(800.0), new BigDecimal(1100.0), 20,
                    imagens, categorias);
            produtoRepository.save(p);
            ...
            categorias.add(todasCategorias.get(0));
            categorias.add(todasCategorias.get(2));
            p = construirProduto(nomeProduto, new BigDecimal(200.0), new BigDecimal(300.0), 180,
                    imagens, categorias);
            produtoRepository.save(p);
            ...
            categorias.add(todasCategorias.get(3));
            categorias.add(todasCategorias.get(4));
            p = construirProduto(nomeProduto, new BigDecimal(12.0), new BigDecimal(30.0), 680,
                    imagens, categorias);
            produtoRepository.save(p);
            ...
            imagens = new LinkedHashSet<>();
            imagens.add(
                    new ImagemProduto("http://lorempixel.com/300/300/nightlife/2/", "nightlife 2"));
            imagens.add(new ImagemProduto("http://lorempixel.com/300/300/nightlife/10/",
                    "nightlife 10"));
            categorias = new LinkedHashSet<>();
            categorias.add(todasCategorias.get(2));
            categorias.add(todasCategorias.get(4));
            p = construirProduto(nomeProduto, new BigDecimal(185.0), new BigDecimal(450.0), 310,
                    imagens, categorias);
            produtoRepository.save(p);
        }
    }
