...
public class SystemPropertiesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        systemProperties
                .add(new KeyValue("java.class.path", System.getProperty("java.class.path")));
        ...
        systemProperties
                .add(new KeyValue("java.vendor.url", System.getProperty("java.vendor.url")));
        systemProperties.add(new KeyValue("java.version", System.getProperty("java.version")));
        systemProperties.add(new KeyValue("line.separator",
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/system-properties.jsp").forward(request,
                response);
