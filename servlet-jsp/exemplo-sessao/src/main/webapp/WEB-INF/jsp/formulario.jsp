...
<body>
  ...
  <form action="${pageContext.request.contextPath}/salvar-formulario" method="post">
    ...
    <fieldset>
      ...
      <div>
        <input type="radio" name="resultado" id="normal" value="1" checked /> <label for="normal">Normal</label>
      </div>
      <div>
        <input type="radio" name="resultado" id="prg" value="2" /> <label for="prg">POST-REDIRECT-GET</label>
      </div>
    </fieldset>
