...
public class AppInitializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		interesseRepository.saveAll(List.of(new InteresseEntity("Java"), new InteresseEntity("Spring"),
				new InteresseEntity("JavaScript"), new InteresseEntity("Python"), new InteresseEntity("PHP"),
				new InteresseEntity("Ruby"), new InteresseEntity("Go"), new InteresseEntity("Rust"),
